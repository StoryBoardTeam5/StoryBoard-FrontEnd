...
const PreTest = ({challengeText, text, challenge, timer, maxpoints, NextDialogRefID, setTypingTestStarted, SwitchGameModeToDialog}: PreTestProps) => {
  return (
    <Card>
    <CardHeader>
    ...
    <CardFooter>
      <div className='flex w-full justify-evenly'>
        <Button size={'xl'} onClick={() => setTypingTestStarted(true)}>Start Typing Test!</Button>
        <Button size={'xl'} onClick={() => SwitchGameModeToDialog(NextDialogRefID)}>Skip Typing Test!</Button>
      </div>
    </CardFooter>
